...
- fix(document): correctly $\_\_reset() subdocuments that are under nested paths #11672
...
- fix(populate): get doc schema using $\_\_schema to avoid paths named `schema` #10619
...
- Fixed; `null` and `undefined` are set automatically.
