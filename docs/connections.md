...
[not need to pass any special options to connect to multiple mongos](https://mongodb.github.io/node-mongodb-native/3.0/tutorials/connect/#connect-to-sharded-cluster) in mongoose 5.x.
