...
const { buildMiddlewareFilter } = require('./helpers/middleware');
 ...
 * @param {Boolean|Object} [options.middleware] set to `false` to skip all user-defined middleware, or `{ pre: false }` / `{ post: false }` to skip only pre or post hooks
 * @see mongodb https://www.mongodb.com/docs/manual/reference/command/aggregate/
 * @return {Aggregate} this
 * @api public
 */
