...
module.exports = function cast(schema, obj) {
  let paths = Object.keys(obj), i = paths.length, any$conditionals, schematype, nested, path, type, val;
  ...
  while (i--) {
    ...
    if (path === '$or' || path === '$nor' || path === '$and') {
      ...
      if (!schematype) {
        ...
        let split = path.split('.'), j = split.length, pathFirstHalf, pathLastHalf, remainingConds;
