...
module.exports = function cast(schema, obj, options, context) {
  // options contains upsert.
  // filter is not available in cast but is in castUpdate
  ...
  const _idPath = schema.tree._id;
  const hasNullishId = obj._id === null || (typeof obj._id === 'undefined' && obj.hasOwnProperty('_id'));
  if (options.upsert && _idPath != null && _idPath.required && hasNullishId) {
    throw new CastError(_idPath.instance, obj._id, '_id');
  }
