...
const utils = require('./utils'), EventEmitter = require('events').EventEmitter, driver = global.MONGOOSE_DRIVER_PATH || './drivers/node-mongodb-native', Schema = require('./schema'), Collection = require(driver + '/collection'), STATES = require('./connectionstate'), MongooseError = require('./error'), muri = require('muri'), PromiseProvider = require('./promise_provider');
 ...
 * @api private
 */
const authMechanismsWhichDontRequirePassword = [
  'MONGODB-X509'
];
