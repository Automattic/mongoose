 ...
 * 
 * ####Example
 *    async function createMultiTenatConnection(tenatId, modelName, schema) {
  *     const conn = await mongoose.createConnection('mongodb://localhost:27017/test');
  *     const dbName = `db_${tenatId}`;
  *     const dbOptions = {
    *     //If true, create one connection object with multiple calls to useDb(). Default id false
    *     userCache:true 
