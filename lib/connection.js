...
Connection.prototype.model = function model(name, schema, collection, options) {
  ...
  if (this.models[name] && collection) {
    ...
    utils.warn('Mongoose: Calling mongoose.model() with an existing model name ' +
      'and a different collection is deprecated. This leads to dangling models. ' +
      'Please use a different model name instead. ' +
      'See: https://mongoosejs.com/docs/deprecations.html#model-dangling-models');
 ...
 * @param {Object} [options]
 * @param {Number} [options.sampleSize=100]
 * @method generateSchemaFromCollection
 * @memberOf Connection
 * @instance
 * @api public
...
Connection.prototype.generateSchemaFromCollection = function(collectionName, options) {
  return require('./helpers/schema/generateSchemaFromCollection')(this, collectionName, options);
};
