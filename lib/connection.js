...
Connection.prototype.openUri = function(uri, options, callback) {
  ...
  if (this._closeCalledWithClean && this.readyState === STATES.disconnected) {
    const error = 'Connection has been closed and cleaned already, and cannot be used for re-opening the connection. ' +
...
Connection.prototype.close = function(force, closeAndClean, callback) {
  ...
  if (closeAndClean != null && typeof closeAndClean !== 'function') {
...
Connection.prototype._close = function(force, closeAndClean, callback) {
  ...
  this._closeCalledWithClean = closeAndClean;
  if (this.client != null) {
    this.client._closeCalled = true;
    this.client._closeCalledWithClean = closeAndClean;
  }
  ...
  switch (this.readyState) {
    ...
    case STATES.connecting:
      this.once('open', function() {
        _this.close(force, closeAndClean, callback);
      });
      break;
