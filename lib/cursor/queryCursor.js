...
const applyVirtuals = require('../helpers/document/applyVirtuals');
...
function _nextDoc(ctx, doc, pop, callback) {
  if (ctx.query._mongooseOptions.lean) {
    if (ctx.query._mongooseOptions.lean.virtuals) {
      applyVirtuals(ctx.model.schema, doc, ctx.query._mongooseOptions.lean.virtuals, {
        skipPopulateVirtuals: true
      });
    }
