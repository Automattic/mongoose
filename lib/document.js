...
function Document(obj, fields, skipId, options) {
  ...
  this.$__buildDoc(obj, fields, skipId);
...
function $__isExclusiveProjection(fields) {
...
Document.prototype.$__buildDoc = function(obj, fields, skipId) {
  ...
  $__applyDefaults(this, fields, skipId);
};
