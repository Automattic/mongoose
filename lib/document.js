  ...
  if ('string' !== typeof path) {
    ...
    if (null === path || undefined === path) {
      ...
      while (i--) {
        ...
        // this is necessary in the case where a raw object is passed in that
        // conforms to thing that this is referencing. Weird scenario, but
        // apparently people use it like that? gh-1606
        var isRef = this.schema.paths[key] && this.schema.paths[key].options.ref ?
          true :
          false;
        if (null != path[key]
