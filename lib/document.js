...
Document.prototype.$__set = function(pathToMark, path, options, constructing, parts, schema, val, priorVal) {
  ...
  if (shouldModify) {
    if (this.$__.primitiveAtomics && this.$__.primitiveAtomics[path]) {
      ...
      if (utils.hasNoOwnKeys(this.$__.primitiveAtomics)) {
...
Document.prototype.$__validate = async function $__validate(pathsToValidate, options) {
  ...
  const _complete = () => {
    ...
    if (shouldValidateModifiedOnly && validationError != null) {
      ...
      if (utils.hasNoOwnKeys(validationError.errors)) {
...
Document.prototype.$markValid = function(path) {
  ...
  if (utils.hasNoOwnKeys(this.$__.validationError.errors)) {
    this.$__.validationError = null;
  }
};
...
function _markValidSubpaths(doc, path) {
  ...
  if (utils.hasNoOwnKeys(doc.$__.validationError.errors)) {
...
Document.prototype.$isValid = function(path) {
  if (this.$__.validationError == null || utils.hasNoOwnKeys(this.$__.validationError.errors)) {
    return true;
  }
  if (path == null) {
    return false;
...
function omitDeselectedFields(self, json) {
  ...
  if (selected == null || utils.hasNoOwnKeys(selected)) {
    return json;
  }
...
function checkDivergentArray(doc, path, array) {
  ...
  if (check) {
    ...
    if (utils.hasNoOwnKeys(atomics) || atomics.$set || atomics.$pop) {
      return path;
    }
  }
}
