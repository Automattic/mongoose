  ...
  if (optimisticConcurrency) {
    if (Array.isArray(optimisticConcurrency)) {
      ...
      const hasRelevantModPaths = pathsToSave == null ?
        modPaths.find(path => _pathOrAncestorInSet(path, optimisticConcurrencySet)) :
        modPaths.find(path => _pathOrAncestorInSet(path, optimisticConcurrencySet) && isInPathsToSave(path, pathsToSaveSet, pathsToSave));
