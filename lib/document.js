...
Document.prototype.$toObject = function(options, json) {
  ...
  return this.$toObjectInternal(options, json);
};

/**
 * Internal version of `$toObject()` for recursive serialization. Avoids setting
 * `_calledWithOptions`, which is expensive. Also avoids cloning `options`.
 *
 * @return {object}
 * @api private
 * @method $toObjectInternal
 * @memberOf Document
 * @instance
 */

Document.prototype.$toObjectInternal = function(options, json) {
