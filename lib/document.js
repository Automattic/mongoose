...
/**
 * Marks that the path has pending changes to be written to the db.
 ...
 *
 * If `path` is given, checks if a path or any full path containing `path` as part of its path chain has been directly modified.
 *
 * ####Example
 *
