 ...
 *
 * @param {Object} obj - values to set
 * @param {Object} fields - which were selected in the query returning this document
 * @param {Boolean} skipId - flag if we should auto create an ObjectId _id
 * @api private
 */
 ...
 * update
 *
 * Sends an update command with this document _id as
 * the query selector.
 *
 * Example:
 *
 ...
 *
 * @param {String|Object} path or object of key/vals
 * @param {Object} value, or undefined
 * @param @optional {Schema|String|...} specify a type for "on-the-fly" attributes
 * @api public
 */
 ...
 * _set
 *
 * Handles the actual setting of the value and marking
 * the path modified if appropriate.
 *
 * @private
 */
 ...
 * markModified
 *
 * Marks that the path has pending changes to be written
 * to the db. Very helpful when using Mixed types.
 *
 ...
 * try
 *
 * Catches errors that occur during execution of fn and
 * stores them to later be passed when save() is executed.
 *
 * @param {Function} function to execute
 * @param {Object} scope - in which to call fn
 * @private
 */
 ...
 * isSelected
 *
 * Checks if a path was selected in the source query which
 ...
 * validate
 *
 * Executes appropriate validation rules for this document.
 *
 * @param {Function} next - will be called after validation is complete
 * @api public
 */
 ...
 * _reset
 *
 * Resets the internal atomics and modified state of this document.
 *
 * @private
 * @return {this}
 */
 ...
 * _setSchema
 *
 * Assigns/compiles `schema` into this documents
 * prototype.
 *
 * @api private
 */
