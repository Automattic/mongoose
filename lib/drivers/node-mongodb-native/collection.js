...
const MongooseCollection = require('../../collection'), Collection = require('mongodb').Collection, utils = require('../../utils');
...
function iter(i) {
  NativeCollection.prototype[i] = function() {
    ...
    const collection = this.collection, args = arguments, _this = this, debug = _this.conn.base.options.debug;
...
function format(obj, sub) {
  let x = utils.clone(obj, {retainKeyOrder: 1});
  let representation;
