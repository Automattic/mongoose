...
const MongooseConnection = require('../../connection'), mongo = require('mongodb'), Db = mongo.Db, Server = mongo.Server, Mongos = mongo.Mongos, STATES = require('../../connectionstate'), ReplSetServers = mongo.ReplSet;
...
function listen(conn) {
  ...
  conn.db.on('timeout', function(err) {
    const error = new Error(err && err.err || 'connection timeout');
