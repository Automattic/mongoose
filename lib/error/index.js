 ...
 * - `FilterValidationError`: error returned from query filter validation when the [`validateFilter`](https://mongoosejs.com/docs/api/query.html#Query.prototype.validateFilter()) option is enabled.
...
/**
 * An instance of this error class will be thrown when [query filter validation](https://mongoosejs.com/docs/api/query.html#Query.prototype.validateFilter()) fails.
 * The `errors` property contains an object whose keys are the paths that failed and whose values are
 * instances of CastError or ValidatorError.
 *
 * @api public
 * @memberOf Error
 * @static
...
MongooseError.FilterValidationError = require('./filterValidation');
