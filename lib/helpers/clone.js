...
function clone(obj, options, isArrayChild) {
  ...
  if (isMongooseObject(obj)) {
    ...
    let ret;
    if (options?._calledWithOptions && typeof obj.$toObjectInternal === 'function') {
      ret = obj.$toObjectInternal({ ...options }, options.json);
    } else if (options?.json && typeof obj.toJSON === 'function') {
