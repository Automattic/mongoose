 ...
 * @param {Schema} schema
 * @param {object} obj
 * @param {boolean|string[]|string[][]} [virtuals] optional virtuals selector; pass `false` to skip, `true` to apply all, or an array of dot-path strings / path segments to whitelist
 * @param {Object} [options]
 * @param {Object} [options.parent]
 * @param {boolean} [options.skipPopulateVirtuals=false]
 * @returns {object} The original object with virtuals applied
 */
...
/**
 * Add the document or documents in `res`
 *
 * @param {object|Array} res subdocument
 * @param {Object} [options]
 * @param {Object|Array} [options.parent = null] the parent document for a particular subdocument. If `res` is an array, `options.parent` should also be an array with same length.
 * @param {Function} [applyVirtualsToResult] the function to call to apply the virtuals
 * @returns void
 */
 ...
 * @param {Object} [options] optional options passed to `applyVirtuals()` and `applyVirtualsToDoc()`
 * @returns void
 */
 ...
 * @param {Object} [options] optional options passed to `applyVirtuals()`
 * @param {Boolean} [options.skipPopulateVirtuals=false] set to `true` to not apply populated virtuals
 * @returns void
 */
