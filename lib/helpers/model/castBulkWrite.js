    ...
    return (callback) => {
      try {
        ...
        if (model.schema.$timestamps != null && op['updateOne'].timestamps !== false) {
          ...
          applyTimestampsToUpdate(now, createdAt, updatedAt, op['updateOne']['update'], {}, model.schema);
        }
    ...
    return (callback) => {
      try {
        ...
        if (model.schema.$timestamps != null && op['updateMany'].timestamps !== false) {
          const createdAt = model.schema.$timestamps.createdAt;
          const updatedAt = model.schema.$timestamps.updatedAt;
          applyTimestampsToUpdate(now, createdAt, updatedAt, op['updateMany']['update'], {}, model.schema);
        }
