...
module.exports = function assignVals(o) {
  ...
  for (i = 0; i < docs.length; ++i) {
    ...
    return mpath.set(o.path, valueToSet, docs[i], lookupLocalFields, setValue, false);
  }
};
...
function valueFilter(val, assignmentOpts, populateOptions, allIds) {
  ...
  // if(typeof populateOptions._queryProjection === 'undefined') return transform(val, allIds)
...
function isPopulatedObject(obj) {
  ...
  //if(typeof obj.$__ == 'undefined') return true;
  //need to add new or statement
