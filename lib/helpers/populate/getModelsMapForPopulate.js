...
module.exports = function getModelsMapForPopulate(model, docs, options) {
  console.log(model.schema.base.options, options);
  if(model.schema.base.options.strictPopulate == false && options.strictPopulate == null) {
    options.strictPopulate = model.schema.base.options.strictPopulate;
  }
  let doc;
