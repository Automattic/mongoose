...
module.exports = function getModelsMapForPopulate(model, docs, options) {
  ...
  const _firstWithRefPath = allSchemaTypes.find(schematype => schematype.options.refPath != null);
  ...
  for (i = 0; i < len; i++) {
    ...
    let normalizedRefPath = _firstWithRefPath ? _firstWithRefPath.options.refPath : null;
