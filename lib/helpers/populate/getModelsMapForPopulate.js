...
module.exports = function getModelsMapForPopulate(model, docs, options) {
  ...
  for (i = 0; i < len; i++) {
    ...
    if (localFieldPathType != null && schema == null && justOne == null) {
      justOne = Array.isArray(localFieldPathType) ?
        localFieldPathType.every(schema => !schema.$isMongooseArray) :
        !localFieldPathType.$isMongooseArray;
    }
