...
module.exports = function castUpdate(schema, obj, options, context, filter) {
  console.log('hello Cast Update');
  console.log(context);
  console.log(context._mongooseOptions);
  if (!('overwriteDiscriminatorKey' in context._mongooseOptions)) {
    // do stuff
  }
  if (obj == null) {
    return undefined;
...
function castUpdateVal(schema, val, op, $conditional, context, path) {
  console.log('hello Cast Update Val');
  console.log(val);
  console.log(context._mongooseOptions);
  if (!schema) {
