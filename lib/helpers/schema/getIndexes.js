  ...
  function collectIndexes(schema, prefix, baseSchema) {
    ...
    for (const key of keys) {
      ...
      if (index !== false && index !== null && index !== undefined) {
        ...
        if (schema.discriminatorMapping && schema.discriminatorMapping.value != null) {
          const discriminatorNameKey = schema.discriminatorMapping.key;
          const discriminatorNameValue = schema.discriminatorMapping.value;

          options.partialFilterExpression = options.partialFilterExpression || {};
          options.partialFilterExpression[discriminatorNameKey] = discriminatorNameValue;
        }
