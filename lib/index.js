...
const querySelector = require('./helpers/query/querySelector');
 ...
 *
 * ```javascript
 * const obj = { username: 'val', pwd: querySelector({ $type: 'string', $eq: 'my secret' }) };
 * sanitizeFilter(obj);
 *
...
Mongoose.prototype.querySelector = querySelector;
