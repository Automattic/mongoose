...
Mongoose.prototype.createConnection = function () {
  var conn = new Connection(this), self = this;
  ...
  //Prevent memory leak as seen here https://github.com/LearnBoost/mongoose/issues/2073
  conn.once('close', function () {
    self.connections = self.connections.filter(function (storedConn) {
      return (conn !== storedConn);
    });
  });
  return conn;
};
