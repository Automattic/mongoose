...
/**
 * The Mongoose BigInt [SchemaType](/docs/schematypes.html). Used for
 * declaring paths in your schema that should be
 ...
 * #### Example:
 *
 *     const vehicleSchema = new Schema({ largeValue: mongoose.BigInt });
 *
 * @property BigInt
 * @api public
 */

Mongoose.prototype.BigInt = SchemaTypes.BigInt;
