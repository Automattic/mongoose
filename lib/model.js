...
} = require('./helpers/indexes/filterIndexes');
...
Model.cleanIndexes = function cleanIndexes(callback) {
  ...
  return this.db.base._promiseOrCallback(callback, cb => {
    ...
    this.listIndexes((err, dbIndexes) => {
      ...
      dbIndexes = filterOutNonDiscriminatorDBIndexes(this, dbIndexes);
      const schemaIndexes = filterOutNonDiscriminatorSchemaIndexes(this, this.schema.indexes());
      ...
      for (const dbIndex of dbIndexes) {
        ...
        for (const [schemaIndexKeysObject, schemaIndexOptions] of schemaIndexes) {
          const options = _decorateDiscriminatorIndexOptions(this, utils.clone(schemaIndexOptions));
