 ...
 * @param {Object} additionalCriteria allows appending additional criteria to update request.
 * @param {Function} fn
 * @api public
 */

Model.prototype.save = function save (additionalCriteria, fn) {
  if ('function' === typeof additionalCriteria) {
    fn = additionalCriteria; 
  ...
  if (this.isNew) {
    ...
    if (delta) {
      var criteria = utils.options({ _id: this._doc._id }, additionalCriteria || {});
