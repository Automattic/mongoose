...
Model.prototype.$__handleSave = function(options, callback) {
  ...
  if ('w' in options.writeConcern) {
    saveOptions.w = options.writeConcern.w;
  }
  if ('j' in options.writeConcern) {
    saveOptions.j = options.writeConcern.j;
  }
  if ('wtimeout' in options.writeConcern) {
    saveOptions.wtimeout = options.writeConcern.wtimeout;
  }
  if ('checkKeys' in options.writeConcern) {
    saveOptions.checkKeys = options.writeConcern.checkKeys;
  }
  // goal is to make saveOptions = writeConcern{saveOptions}
  saveOptions = { writeConcern: saveOptions };
