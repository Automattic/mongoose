...
Model.prototype.$__handleSave = function(options, callback) {
  ...
  if (this.isNew) {
    ...
    // console.log('over here scoob');
    // console.log('this is the return value of delta from dirty', delta);
    if (delta) {
    ...
    // need to prevent this from being called early
    this.$__reset();
...
Model.prototype.$__delta = function() {
  ...
  console.log('this is dirty', dirty);
  // console.log(new Error().stack);
  // console.log(this);
  // console.log(this.$__.$options);
  // console.log('hello');
