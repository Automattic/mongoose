...
_compileEtters = function(props, getters, setters, prototype, path, orproto){
  for (var i in props){
    var p = (path ? path + '.' : '') + i;
    (function(props, getters, setters, p, i, orproto){
      if (props[i] == null || props[i] instanceof Array){
        // prototype.__proto__ = orproto;
        ...
        prototype[i].__proto__ = orproto || prototype;
        _compileEtters(props[i], getters[i] || {}, setters[i] || {}, prototype[i].prototype, p, orproto || prototype);
      }
    })(props, getters, setters, p, i, orproto);
  }
};
