...
Model.aggregate = function aggregate(pipeline, options, callback) {
  ...
  const defaultAllowDiskUse = this.base.options.allowDiskUse != null ? this.base.options.allowDiskUse : false;
  const operationAllowDiskUse = options && options.allowDiskUse;
  if (operationAllowDiskUse == null) {
    aggregate.option({ allowDiskUse: defaultAllowDiskUse });
  }
