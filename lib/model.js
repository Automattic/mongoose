...
Model.useConnection = function useConnection(connection) {
  ...
  if (typeof connection.collection !== 'function') {
    throw new MongooseError('connection must be a valid Mongoose Connection instance. ' +
      'Please ensure the object has a collection() method.');
  }
  if (typeof connection.model !== 'function') {
    throw new MongooseError('connection must be a valid Mongoose Connection instance. ' +
      'Please ensure the object has a model() method.');
  }
  if (this.db) {
