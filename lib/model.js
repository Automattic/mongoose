...
function populate(model, docs, options, callback) {
  ...
  if (options.localField || options.foreignField) {
    // reassign options._localModel.schema.virtuals[virtual].options.localField on populateOptions
  }
  if (options.foreignField) {
    // reassign options._localModel.schema.virtuals[virtual].options.foreignField on populateOptions
  }
