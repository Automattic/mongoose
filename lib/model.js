...
(function(){
  ...
  Model.compile = function(name, model, connection){
    var _model = object.mixin(true, {}, model),
        ...
        _props = _model.properties, setters = _model.setters || {}, getters = _model.getters || {}, _indexes = _model.indexes;
    ...
    if (_indexes && _indexes.length) connection._collection.setIndexes(_indexes);
