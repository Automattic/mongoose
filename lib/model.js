...
Model.bulkSave = function(documents) {
  ...
  // err.writeErrors.map(documentError=>documentError.err.op.q._id)
  return this.bulkWrite(writeOperations);
};

Model.buildBulkWriteOperations = function buildBulkWriteOperations(documents) {
