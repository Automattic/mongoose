 ...
 * Examples:
 *
 *     A.updateOne(conditions, update, options, callback) // executes
 *     A.updateOne(conditions, update, options)  // returns Query
 *     A.updateOne(conditions, update, callback) // executes
 *     A.updateOne(conditions, update)           // returns Query
 *     A.updateOne()                             // returns Query
 *
 * @param {Object} conditions
 * @param {Object} update
...
Model.updateOne = function (conditions, update, options, callback) {
  ...
  var query = new Query(conditions, options);
  query.select(fields);
  query.bind(this, 'updateOne', update);
