  ...
  for( var k in update){
    ...
    for( var keyToUpdate in toCycle){ 
      ...
      (function(){ // Make a separate context
        ...
        explore( currValue, currSchema, currPath );

        function explore( obj, schema, path ){

          console.log("Explore entered. Obj: '%j', path: '%s'" , obj, path);
          ...
          switch (pathType.type) {
            ...
            case 'mixed':
              ...
              validatePath( schema, path, keyToUpdate + '.' + path, obj );
              return;
            break;
            ...
            case 'array':
              ...
              if( Array.isArray(obj)){
                for( var k in obj ){
                  ...
                  validatePath( schema, path, keyToUpdate + '.' + k + '.' + path, obj[k] );
                }
              }
              return;
            ...
            case 'notFound':
              ...
              if (Array.isArray(obj) ){
                console.log('Value is an array, will explore each item separately');
                for(var k in obj){
                  explore( obj[k], schema, path );
                }
              } else if( typeof(obj) == 'object'){
                console.log('Value is an object, will continue looking for paths');
                for( var k in obj ){
                  explore( obj[k], schema, path == '' ? k : path + '.' + k );
                }
              } else {
