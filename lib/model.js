...
var Document = require('./document')
  ...
  , util = require('util')
  , tick = utils.tick
  , MongooseQuery = require('./mongoosequery.js')
...
Model.remove = function remove (conditions, callback) {
  ...
  var mq = new MongooseQuery(this.collection.collection, {}, this);
...
Model.find = function find (conditions, fields, options, callback) {
  ...
  // get the raw mongodb collection object
  var mq = new MongooseQuery(this.collection.collection, options, this);
  mq.select(fields);
...
Model.distinct = function distinct (conditions, field, callback) {
  // get the raw mongodb collection object
  var mq = new MongooseQuery(this.collection.collection, {}, this);
...
Model.where = function where (path, val) {
  // get the raw mongodb collection object
  var mq = new MongooseQuery(this.collection.collection, {}, this).find({});
...
Model.geoNear = function (near, options, callback) {
  ...
  this.collection.geoNear(x, y, options, function (err, res) {
    if (err) return callback(err);
    if (options.lean) return callback(err, res);
