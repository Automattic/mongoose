...
function populate(model, docs, options, callback) {
  ...
  const originalLocalField = model.schema.virtuals[populateOptions.path].options.localField;
  ...
  model.schema.virtuals[populateOptions.path].options.localField = originalLocalField;
