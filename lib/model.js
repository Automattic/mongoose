...
Model._applyUpdateValidation = function( update,  enableValidation, cb ){
  ...
  for( var k in update){
    ...
    for( var keyToUpdate in toCycle){ 
      ...
      // The model's schema is the "root" schema to consider
      ...
      var dontCheck = false;
      for (var i = 0, l = cleanKeyToUpdate.length; i < l; i++) {
