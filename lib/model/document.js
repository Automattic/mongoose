var object = require('../utils/object'),
    ...
    Document = function(data,schema,getters,setters,strict,embedded,pkey,idx){
      ...
      Document.ensureField(this,'__strict',strict);
      if(embedded){
      ...
      Document.ensureField(this,'__makeDirty',function(){
        self.__dirty = true;
        if(self.__parent) self.__parent.__makeDirty();
      });
      
      Document.ensureField(this,'__makeClean',function(){
        self.__dirty = false;
      });
      
      Document.ensureField(this,'__meta__',{
        removed: false,
        saving: false
      });
    ...
    Document.addSetter = function(scope,field,setter,enum){
      object.addSetter(scope,field,function(val){
        val = (object.type(val) && val.__doc) ? val.__doc : val;
        scope.__doc[field] = (typeof setter == 'function') ? setter.call(scope,val) : val;
        // mark as dirty and bubble up parents
      },enum);
    };
    ...
    Document.removeProperty = function(field,data,getters,setters){
      ...
      delete data[field];
      if(getters && getters[field] !== undefined) delete getters[field];
      if(setters && setters[field] != undefined) delete setters[field];
    };
