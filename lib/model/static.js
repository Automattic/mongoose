...
this.Static = {
    ...
    drop : function(){ return this._cmd('drop', Array.prototype.slice.call(arguments,0)); },

    _cmd : function(cmd,args){
      return new QueryPromise(cmd,args,this);
      /*
      var operation = { 
            name : cmd,
      ...
      if(!operation.callback) return new QueryPromise(operation,this);
      this.dequeue();
      */
    },
