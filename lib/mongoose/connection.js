...
Connection.prototype.model = function (name, collection) {
  ...
  if (!this.models[collection][name]){
    var model = this.base.model(name, null, collection)
      , newmodel;
    ...
    if (model.prototype.connection != this){
      ...
      newmodel.prototype.__proto__ = model.prototype;
      newmodel.prototype.db = this;
      newmodel.prototype.collection = this.collection(collection);
    }

    this.models[collection][name] = newmodel || model;
  }
