...
Document.prototype.buildDoc = function () {
  ...
  for (var i in paths){
    ...
    path.reduce( function (ref, piece) {
      if (!ref) return doc[piece] || (doc[piece] = {});
      ref[piece] = type.initValue(this);
      return ref;
    }, null);
  }
      ...
      return function () {
        ...
        function error(err){
          if (typeof args[args.length - 1] == 'function')
            args[args.length - 1].call(self, err);
        };
          ...
          function parallel () {
            ...
            if (complete){
              ...
              pres.parallel.forEach(function (fn) {
                chain.push(function (err) {
                  err ? error(err) : fn.call(self, chain[i + 1], done);
                });
              });
