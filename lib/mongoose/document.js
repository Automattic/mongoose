...
function cloneForMongo (obj) {
  if (obj === undefined || obj === null)
    return obj
  if (Array.isArray(obj)) {
    return obj.length ? cloneArray(obj) : undefined;
  }
  if (obj.toObject)
    return obj.toObject();
  if (obj.constructor == Object) {
    return cloneObjForMongo(obj);
  }
...
function cloneObjForMongo (obj) {
  var ret = {}
    , val
    , hasKeys;
  for (var k in obj) {
    val = cloneForMongo(obj[k]);
