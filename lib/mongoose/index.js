...
Connection.prototype._compile = function(name){
  ...
  for(prop in schema._staticGetters) model.__defineGetter__(prop, schema._staticGetters[prop]);
  for(prop in schema._staticSetters) model.__defineSetter__(prop, schema._staticSetters[prop]);
