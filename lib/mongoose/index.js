...
/*
          ...
          sys.inherits(embedded, EmbeddedDocument);
          embedded.prototype.
          embedded.prototype._schema = options._schema;
*/          
      ...
      this._addType(key, new type(name, key, options, this));
