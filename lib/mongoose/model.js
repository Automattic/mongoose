...
var Document = require('./document')
  ...
  , UpdateQuery = require('./query').UpdateQuery
  , CountQuery = require('./query').CountQuery
  , RemoveQuery = require('./query').RemoveQuery
  , utils = require('./utils')
...
Model.remove = function (conditions, callback) {
  var query = new RemoveQuery(conditions).bind(this);
...
Model.find = function (conditions, fields, options, callback) {
  ...
  var query = new FindQuery(conditions, fields, options).bind(this);
...
Model.findOne = function (conditions, fields, options, callback) {
  ...
  var query = new FindOneQuery(conditions, fields, options).bind(this);
  if ('undefined' === typeof callback) return query;
  return query.run(callback);
};
...
Model.count = function (conditions, callback) {
  var query = new CountQuery(conditions).bind(this);
  if ('undefined' === typeof callback) return query;
  return query.run(callback);
};
...
Model.update = function (conditions, doc, options, callback) {
  ...
  var query = new UpdateQuery(conditions, doc, options).bind(this);
  if ('undefined' === typeof callback) {
    return query;
  }
  return query.run(callback);
