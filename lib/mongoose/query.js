...
FindQuery.prototype.run = function (callback) {
...
FindOneQuery.prototype.run = function (callback) {
  var model = this.model;
...
CountQuery.prototype.run = function (callback) {
  var model = this.model;
  this.cast(model);
  var castQuery = this._conditions;
...
UpdateQuery.prototype.run = function (callback) {
  var model = this.model
    , options = this._optionsForExec(model);
  ...
  this.cast.call({_conditions: this.doc}, model);
...
RemoveQuery.prototype.run = function (callback) {
  var model = this.model;
  this.cast(model);
  var castQuery = this._conditions;
