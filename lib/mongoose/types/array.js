...
ModelSubdocsArray.prototype.__proto__ = ModelArray.prototype;
...
ModelSubdocsArray.prototype.id = function(id) {
...
ModelSubdocsArray.prototype.applyDefaults = function(next){
  if (!this.length)
    return next();
...
ModelSubdocsArray.prototype.validate = function(next) {
  if (!this.length)
    return next();
...
exports.ModelSubdocsArray = ModelSubdocsArray;
