...
MongooseArray.prototype.$push = MongooseArray.prototype.push = function () {
  var obj = this._cast(obj)
    , ret = oldPush.apply(this, arguments);
  if (arguments.length === 1)  {
    this._registerAtomic(['$push', arguments[0]]);
  } else {
    this._registerAtomic(['$pushAll', arguments.length]);
  }
  return ret;
};
...
MongooseArray.prototype.nonAtomicPush = function () {
  var itemsToPush = Array.prototype.map.apply(arguments, function (obj) {
        return this._cast(obj);
      })
    , ret = oldPush.apply(this, itemsToPush);
  this._markModified();
  return ret;
};
