...
module.exports = {
  ...
  subclass: function(type, proto){
    ...
    var constructor = proto.constructor,
        ...
        Obj = process.binding('evals').Script.runInNewContext('x = '+type.name),
        obj = function(){
          var instance = new Obj();
          if(constructor) constructor.apply(instance, arguments);
          return instance;
        };
        obj.prototype.__proto__ = type.prototype;
        Obj.prototype.__proto__ = obj.prototype; // passed instanceof tests
