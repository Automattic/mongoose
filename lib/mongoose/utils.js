...
StateMachine.ctor = function () {
  var states = exports.args(arguments);
  var ctor = function () {
  ...
  _iter: function (iterMethod) {
    return function () {
      var numArgs = arguments.length
        , states = exports.args(arguments, 0, numArgs-1)
...
/**
 * Array.prototype.slice.call(arguments) alternative
 */

exports.args = function (args, slice, sliceEnd) {
  var ret = [];
  slice = slice || 0;
  sliceEnd = 3 === arguments.length
    ? sliceEnd
    : args.length;

  for (var i = slice, r = 0; i < sliceEnd; ++i, ++r) {
    ret[r] = args[i];
  }
