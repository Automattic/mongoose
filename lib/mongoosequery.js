...
function MongooseQuery(collection, options, model) {
...
MongooseQuery.prototype.find = function (conditions, callback) {
  ...
  if (!callback) {
    ...
    // if we do have a callback, make sure to cast all the values before
    // returning
...
MongooseQuery.prototype.lean = function (v) {
  this._mongooseOptions = arguments.length ? !!v : true;
  return this;
}

MongooseQuery.prototype.findOne = function (conditions, callback) {
...
MongooseQuery.prototype.update = function (conditions, doc, options, callback) {
  ...
  return MongooseQuery.base.update.call(this, conditions, doc, options, callback);
}
...
MongooseQuery.prototype.cast = function (model, obj) {
  ...
  while (i--) {
    ...
    if ('$or' === path || '$nor' === path || '$and' === path) {
      ...
      while (k--) {
        orComponentQuery = new MongooseQuery(val[k]);
      ...
      if (!schematype) {
        ...
        if (schematype) {
          ...
          if (schematype.caster && schematype.caster.schema) {
            ...
            castingQuery = new MongooseQuery(remainingConds);
