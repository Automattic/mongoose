...
Query.prototype.select = function select() {
  ...
  if (utils.hasUserDefinedProperty(this.model.db.options, 'sanitizeProjection')) {
    sanitizeProjection = this.model.db.options.sanitizeProjection;
  } else if (utils.hasUserDefinedProperty(this.model.base.options, 'sanitizeProjection')) {
