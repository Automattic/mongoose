...
const VALID_MQUERY_OPTIONS = new Set(['tailable', 'sort', 'limit', 'skip', 'maxScan', 'maxTime', 'batchSize', 'comment', 'snapshot', 'hint', 'slaveOk', 'safe']);
...
Query.prototype.setOptions = function(options, overwrite) {
  ...
  for (const option of Object.keys(optionsToSendToMQuery)) {
    if (VALID_MQUERY_OPTIONS.has(option) === false) {
      delete optionsToSendToMQuery[option];
    }
  }

  return Query.base.setOptions.call(this, optionsToSendToMQuery);
};
