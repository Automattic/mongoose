...
/**
 * _createUninitedInstance

 * Get an instance of the Model that is approriate for the given doc and fields
 * the instance does NOT have data from the doc yet.

 * @api private
 */
Query.prototype._createUninitedInstance = function(Model, doc, fields) {
  Model = Model.getModelForDoc ?
    Model.getModelForDoc(doc) :
    Model;
...
Query.prototype.execFind = function (callback) {
  ...
  function cb (err, docs) {
    ...
    for (var i = 0, l = docs.length; i < l; i++) {
      arr[i] = self._createUninitedInstance(model, docs[i], fields);
...
Query.prototype.findOne = function (callback) {
  ...
  model.collection.findOne(castQuery, options, tick(function (err, doc) {
    ...
    var casted = self._createUninitedInstance(model, doc, fields);
...
function each (callback) {
  ...
  model.collection.find(this._conditions, options, function (err, cursor) {
    ...
    function onNextObject (err, doc) {
      ...
      var instance = self._createUninitedInstance(model, doc, fields);
