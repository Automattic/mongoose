...
Query.prototype._findOne = function (callback) {
  ...
  Query.base.findOne.call(_this, {}, function (err, doc) {
    ...
    if (!options.populate) {
      return true === options.lean
        ? callback(null, doc)
        : completeOne(_this.model, doc, projection, _this, null, callback);
    }
    ...
    _this.model.populate(doc, pop, function (err, doc) {
      ...
      return true === options.lean
        ? callback(null, doc)
        : completeOne(_this.model, doc, projection, _this, pop, callback);
    });
  });
};
...
Query.prototype._findAndModify = function (type, callback) {
  ...
  var cb = function (err, doc) {
    ...
    if (!options.populate) {
      return true === options.lean
        ? callback(null, doc)
        : completeOne(_this.model, doc, fields, _this, null, callback);
    }
    ...
    _this.model.populate(doc, pop, function (err, doc) {
      ...
      return true === options.lean
        ? callback(null, doc)
        : completeOne(_this.model, doc, fields, _this, pop, callback);
    });
  };
