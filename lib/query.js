...
Query.prototype.findOneAndUpdate = function() {
  ...
  if (hasCallback && this.schema) {
    this.schema.s.hooks.wrap('findOneAndUpdate', Query.base.findOneAndUpdate,
...
Query.prototype.update = function (conditions, doc, options, callback) {
  ...
  var updateFunction = Query.base.update;
  if (callback && this.schema) {
    updateFunction = this.schema.s.hooks.createWrapper('update', Query.base.update, this);
  }
  ...
  if (options && options.runValidators && callback) {
    ...
    doValidate(function(err) {
      ...
      updateFunction.call(_this, castedQuery, castedDoc, options, callback);
    });
    return this;
  }

  return updateFunction.call(this, castedQuery, castedDoc, options, callback);
}
