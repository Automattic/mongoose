...
function isEmptyFilter(obj) {
  ...
  if (utils.hasNoOwnKeys(obj)) return true;
...
Query.prototype._fieldsForExec = function() {
  ...
  if (utils.hasNoOwnKeys(this._fields)) {
    return null;
  }
...
Query.prototype._findOneAndUpdate = async function _findOneAndUpdate() {
  ...
  if (!this._update || utils.hasNoOwnKeys(this._update)) {
    if (options.upsert) {
    ...
    if (this._update.$set && utils.hasNoOwnKeys(this._update.$set)) {
...
Query.prototype._mergeUpdate = function(update) {
  ...
  if (update == null || (typeof update === 'object' && utils.hasNoOwnKeys(update))) {
    return;
  }
...
async function _updateThunk(op) {
  ...
  if (isOverwriting) {
    ...
    if (this._update == null || utils.hasNoOwnKeys(this._update)) {
