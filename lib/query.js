...
Query.prototype.update = function (conditions, doc, options, callback) {
  ...
  if (options && options.upsert) {
    paths = Object.keys(this._conditions);
    numPaths = keys.length;
    for (var i = 0; i < numPaths; ++i) {
      if (typeof this._conditions[paths[i]] === 'Object') {
        var conditionKeys = Object.keys(this._conditions[paths[i]]);
  ...
  if (options && options.runValidators && callback) {
    ...
    async.parallel(validatorsToExecute, function() {
      ...
      return Query.base.update.call(_this, castedQuery, castedDoc, options, callback);
    });
    return;
  }
