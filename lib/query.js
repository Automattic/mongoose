...
Query.prototype._updateMany = async function _updateMany() {
  ...
  return this.mongooseCollection.updateMany(castedQuery, this._update, options);
};
...
Query.prototype._updateOne = async function _updateOne() {
  ...
  return this.mongooseCollection.updateOne(castedQuery, this._update, options);
};
...
Query.prototype._replaceOne = async function _replaceOne() {
  ...
  return this.mongooseCollection.replaceOne(castedQuery, this._update, options);
};
