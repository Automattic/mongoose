...
MongooseQuery.prototype.find = function (conditions, callback) {
  ...
  if (!callback) {
    ...
    var self = this;
    return MongooseQuery.base.find.call(this, {}, cb);
...
MongooseQuery.prototype.update = function (conditions, doc, options, callback) {
  ...
  // want to execute an unsafe write. We should probably remove this in 4.0 and
...
MongooseQuery.prototype.maxscan = MongooseQuery.base.maxScan;
...
MongooseQuery.prototype.center = MongooseQuery.base.circle;
...
MongooseQuery.use$geoWithin = mquery.use$geoWithin;

/**
 * Toggles the use of $geoWithin and $within. By default, Mongoose uses $geoWithin
 *
 * @api public
 */

MongooseQuery.prototype.toggle$geoWithin = function () {
  MongooseQuery.use$geoWithin = !MongooseQuery.use$geoWithin;
}
