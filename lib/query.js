...
Query.prototype._find = wrapThunk(function(callback) {
  ...
  const cb = (err, docs) => {
    ...
    if (!mongooseOptions.populate) {
      if (mongooseOptions.lean && mongooseOptions.lean.versionKey === false && _this.schema.options.versionKey) {
        docs.forEach((doc) => {
          delete doc[_this.schema.options.versionKey];
        });
      }
...
Query.prototype._findOne = wrapThunk(function(callback) {
  ...
  Query.base.findOne.call(this, {}, (err, doc) => {
    ...
    if (mongooseOptions.lean && mongooseOptions.lean.versionKey === false && this.schema.options.versionKey) {
      delete doc[this.schema.options.versionKey];
    }
...
Query.prototype._findAndModify = function(type, callback) {
  ...
  const cb = function(err, doc, res) {
    ...
    const mongooseOptions = _this._mongooseOptions;
    if (mongooseOptions.lean && mongooseOptions.lean.versionKey === false && _this.schema.options.versionKey) {
      delete doc[_this.schema.options.versionKey];
    }
