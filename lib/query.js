...
Query.prototype._getPathType(path){
  ...
  return { type: 'other', object: {} }; // ...?

  }



Model.prototype._getUpdateKeySchemaAndPath(pathString){
  var r = {}
...
Model._applyUpdateValidation = function( obj, cb ){
  ...
  // Val_idation is not switched off -- calling the callback straight
