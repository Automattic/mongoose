...
Query.prototype._findOneAndDelete = function(callback) {
  ...
  this._collection.collection.findOneAndDelete(filter, options, (err, res) => {
    ...
    // No doc means nothing to hydrate and nothing to populate
    if (!doc) {
      return callback(null, null);
    }
    ...
    if (!this._mongooseOptions.populate) {
      if (!!options.lean === true) {
        return _completeOneLean(doc, res, options, callback);
      }
      return completeOne(this.model, doc, res, options, fields,
        userProvidedFields, null, callback);
    }

    const pop = helpers.preparePopulationOptionsMQ(this, this._mongooseOptions);
    this.model.populate(doc, pop, (err, doc) => {
      if (err) {
        return callback(err);
      }
      ...
      return completeOne(this.model, doc, res, options, fields,
        userProvidedFields, pop, callback);
    });
  });
