...
/**
 * Check if query fields are inclusive
 *
 * @return {Boolean} bool defaults to true
 * @api public
 */

Query.prototype.fieldsAreInclusive = function () {
  if (!this._fields || Object.keys(this._fields).length === 0) {
    return false;
  }

  for (var i in Object.keys(this._fields)) {
    if (this._fields[Object.keys(this._fields)[i]] === 0) {
      return false;
    }
  }
