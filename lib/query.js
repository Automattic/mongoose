  ...
  const cb = (err, docs) => {
    ...
    if (!mongooseOptions.populate) {
      ...
      // call _completeManyLean here?
        _completeManyLean(_this.model, docs, fields, userProvidedFields, completeManyOptions, callback) :
        // callback(null, docs) :
...
function _completeOneLean(doc, res, opts, callback) {
  // need to recurse on subdocs like arrays and what not.
