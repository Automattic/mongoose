 ...
 * undefined, the `exec()` promise will reject.
 *
 * ####Example:
 *
...
Query.prototype._setCastError = function _setCastError(err) {
  if (err == null && this._error != null && !(this._error instanceof CastError)) {
    return;
  }
