 ...
 * `validateFilter` query option is enabled.
 *
 * ignore
...
Query.prototype._castConditions = function() {
  ...
  if (this.options.validateFilter && this.model) {
    return this.model.validateFilter(this._conditions, this).catch(err => {
      this.error(err);
    });
  }
};
