...
Query.prototype.exec = function (op, callback) {
  ...
  if ('update' == this.op || 'updateOne' == this.op) {
 ...
 * Examples:
 *
 *     query.updateOne(conditions, update, options, callback) // executes
 *     query.updateOne(conditions, update, options)  // returns Query
 *     query.updateOne(conditions, update, callback) // executes
 *     query.updateOne(conditions, update)           // returns Query
 *     query.updateOne()                             // returns Query
 *
 * @param {Object} query
 * @param {Object} doc
 * @param {Object} options
...
Query.prototype.updateOne = function updateOne (query, doc, options, callback) {
  this.op = 'updateOne';
 ...
 * Examples:
 *
 *     A.where().removeOne(conditions, options, callback) // executes
 *     A.where().removeOne(conditions, options)  // return Query
 *     A.where().removeOne(conditions, callback) // executes
 *     A.where().removeOne(conditions) // returns Query
 *     A.where().removeOne()           // returns Query
 *
...
Query.prototype.removeOne = function (conditions, options, callback) {
  this.op = 'removeOne';
...
Query.prototype._findAndModify = function (type, callback) {
  ...
  if ('update' == type) {
    castedDoc = castDoc(this);
    if (!castedDoc) {
      process.nextTick(promise.complete.bind(promise));
      return promise;
    } else if (castedDoc instanceof Error) {
