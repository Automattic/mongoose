...
Query.prototype.read = function (pref, tags) {
  // TODO abstract to utils.js so we can use it here and in schema options
  // TODO solve for invalid schema.options setting later
  switch (pref) {
    case 'p':
      pref = 'primary';
      break;
  ...
  this.options.readPreference = new ReadPref(pref, tags);
  return this;
}
