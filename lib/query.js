 ...
 * ####Example:
 *
 *     var query = new Query(model.collection);
...
function Query(collection, options, model, conditions) {
...
Query.prototype.find = function (conditions, callback) {
  ...
  if (!callback) {
    ...
    return Query.base.find.call(this, {}, callback);
  } else {
...
Query.prototype.findOne = function (conditions, fields, options, callback) {
  ...
  if (!callback) {
    ...
    return Query.base.findOne.call(this, {}, callback);
  } else {
    ...
    Query.base.findOne.call(this, {}, cb);
...
Query.prototype.cast = function (model, obj) {
  ...
  while (i--) {
    ...
    if ('$or' === path || '$nor' === path || '$and' === path) {
      ...
      while (k--) {
        orComponentQuery = new Query(this.mongooseCollection, {}, null, val[k]);
      ...
      if (!schematype) {
        ...
        if (schematype) {
          ...
          if (schematype.caster && schematype.caster.schema) {
            ...
            castingQuery = new Query(this.mongooseCollection, {}, null, remainingConds);
...
Query.prototype.box = function () {
  ...
  Query.base.box.apply(this, arguments);
}
 ...
 *
 * @depreciated use center() instead
 * @param {String} [path]
 * @param {Object} val
 * @return {Query} this
 * @see http://www.mongodb.org/display/DOCS/Geospatial+Indexing
...
/**
 * Allows for users to set use of $geoWithin or $within
 *
 * @api public
