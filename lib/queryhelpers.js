...
exports.applyPaths = function applyPaths(fields, schema) {
  ...
  function analyzePath(path, type) {
    ...
    console.log(type);
    // console.log(path);
    // console.log(isPathExcluded(fields, path) && exclude && (type.selected || path === schema.options.discriminatorKey) && fields[path] != null && !fields[path])
    if (isPathExcluded(fields, path) && exclude && (type.selected || path === schema.options.discriminatorKey) && fields[path] != null && !fields[path]) { // this needs to be false for some cases
      delete fields[path];
      return;
    }
