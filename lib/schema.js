...
Schema.prototype.discriminator = function(obj) {
  this._applyDiscriminators = obj;
};
...
Schema.prototype.add = function add(obj, prefix) {
  ...
  for (const key of keys) {
    ...
    if (!(isPOJO(val) || val instanceof SchemaTypeOptions)) {
      ...
      } else if (val.instanceOfSchema) {
        const applyDiscriminators = val._applyDiscriminators || [];
        discriminator({schema: applyDiscriminators}, key, this); // doesn't work
      }
