...
function _deleteVirtualPath(schema, name) {
  ...
  if (virtuals[name]) {
    ...
    throw new MongooseError('Attempting to delete a virtual path that does not exist.'); // You should never see this message
  }
}
