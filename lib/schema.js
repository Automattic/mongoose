 ...
 * - [skipNestedIndexes](https://mongoosejs.com/docs/guide.html#skipNestedIndexes): boolean - defaults to `false`. If true, automatic index build skips any indexes defined in nested schemas.
