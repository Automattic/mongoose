...
function Schema (obj, options) {
  ...
  // ensure the documents get an auto _id
  var autoId = !this.paths['_id'] && (!this.options.noId && this.options._id);
  if (autoId) {
 ...
 *
 *     var ObjectId = mongoose.Schema.Types.Mixed;
 *     new mongoose.Schema({ _user: ObjectId })
 *
 * @api public
 */
