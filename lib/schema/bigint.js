 ...
 * #### Example:
 *
 *     // Make all bigints have `required` of true by default.
 *     mongoose.Schema.BigInt.set('required', true);
 *
 *     const User = mongoose.model('User', new Schema({ test: mongoose.BigInt }));
 ...
 * #### Example:
 *
 *     // Make Mongoose cast empty strings '' to 0 for paths declared as BigInts
