...
SchemaDocumentArray.prototype.toJSONSchema = function toJSONSchema(options) {
  const itemsTypeDefinition = createJSONSchemaTypeDefinition('object', 'object', {}, { ...options, _overrideRequired: false });
  return {
    ...createJSONSchemaTypeDefinition('array', 'array', this.options, options),
