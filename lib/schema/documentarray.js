...
DocumentArray.prototype.doValidateSync = function(array, scope) {
  ...
  let count = array && array.length, resultError = null;
...
function scopePaths(array, fields, init) {
  ...
  let path = array.path + '.', keys = Object.keys(fields), i = keys.length, selected = {}, hasKeys, key;
