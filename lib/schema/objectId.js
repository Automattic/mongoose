...
SchemaObjectId.prototype.toJSONSchema = function toJSONSchema(options) {
  return createJSONSchemaTypeDefinition('string', 'objectId', this.options, {
    ...options,
    _overrideRequired: options?._overrideRequired ?? (this.options.required === undefined ? this.path === '_id' : undefined)
  });
};
