...
function hex2buffer(hex) {
  ...
  //   const h = hex.substring(i, i + 2 + 1);
  //   const n = parseInt(h, 16);
  //   arr.push(n);
  // }

  // const buff = Buffer.from(arr);
  // console.log('test', buff.toString('utf8'));
 ...
 * @api public
 */
SchemaUUID.schemaName = 'SchemaUUID';
...
SchemaUUID._cast = function(value, doc, init) {
  if (value === null) {
    return value;
  }
