...
StateMachine.prototype.clear = function clear(state) {
  let keys = Object.keys(this.states[state]), i = keys.length, path;
...
StateMachine.prototype._iter = function _iter(iterMethod) {
  return function() {
    let numArgs = arguments.length, states = utils.args(arguments, 0, numArgs - 1), callback = arguments[numArgs - 1];
