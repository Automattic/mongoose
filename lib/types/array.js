...
MongooseArray.mixin = {
  ...
  _markModified: function(elem, embeddedPath) {
    let parent = this._parent, dirtyPath;
  ...
  pull: function() {
    let values = [].map.call(arguments, this._cast, this), cur = this._parent.get(this._path), i = cur.length, mem;
