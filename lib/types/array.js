...
MongooseArray.prototype._cast = function (value) {
  ...
  if (this._parent && value instanceof Document) {
    owner = this._parent.ownerDocument
      ? this._parent.ownerDocument()
      : this._parent;
    populated = owner.populated(this._path);
  }

  return this._schema.caster.cast(value, this._parent, populated)
}
