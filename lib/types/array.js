...
MongooseArray.prototype._cast = function (value) {
  ...
  // this case
  if (this._schema.casterConstructor.name == 'SchemaBuffer' && dim == 1) {
  ...
  if (dim) {
    ...
    if (this._schema.casterConstructor.name != 'Mixed' && value instanceof Array) {
  ...
  if(dim || this._schema.casterConstructor.name == 'Mixed') {
    return ret;
  } else {
    return ret[0];
  }
