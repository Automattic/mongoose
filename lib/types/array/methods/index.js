...
const internalToObjectOptions =
  require("../../../options").internalToObjectOptions;
const mpath = require("mpath");
const utils = require("../../../utils");
const isBsonType = require("../../../helpers/isBsonType");

const arrayAtomicsSymbol =
  require("../../../helpers/symbols").arrayAtomicsSymbol;
const arrayParentSymbol = require("../../../helpers/symbols").arrayParentSymbol;
const arrayPathSymbol = require("../../../helpers/symbols").arrayPathSymbol;
const arraySchemaSymbol = require("../../../helpers/symbols").arraySchemaSymbol;
const populateModelSymbol =
  require("../../../helpers/symbols").populateModelSymbol;
...
const methods = {
  ...
  _cast(value) {
    ...
    if (populated && value !== null && value !== undefined) {
      ...
      const isDisc =
        value.schema &&
        value.schema.discriminatorMapping &&
          ...
          val.map((v) => {
            return v.toObject({
              transform: (doc, ret) => {
                ...
                Object.keys(v.$__.activePaths.getStatePaths("default")).forEach(
                  (path) => {
  ...
  pull() {
    const values = [].map.call(this, arguments, this._cast, this);
    ...
    if (
      cleanModifiedSubpaths(this[arrayParentSymbol], this[arrayPathSymbol]) > 0
    ) {
      this._registerAtomic("$set", this);
    }
  ...
  push() {
    ...
    let atomic = values;
    const isOverwrite =
      values[0] != null && utils.hasUserDefinedProperty(values[0], "$each");
    ...
    if (isOverwrite) {
      ...
      if (
        ((atomics.$push && atomics.$push.$each && atomics.$push.$each.length) ||
          0) !== 0 &&
        atomics.$push.$position != atomic.$position
      ) {
        throw new MongooseError(
          "Cannot call `Array#push()` multiple times " +
...
function _minimizePath(obj, parts, i) {
  ...
  if (
    obj[parts[0]] != null &&
    typeof obj[parts[0]] === "object" &&
    Object.keys(obj[parts[0]]).length === 0
  ) {
    delete obj[parts[0]];
  }
}
  ...
  const ref =
    arr == null
      ...
      : (arr[arraySchemaSymbol] &&
          arr[arraySchemaSymbol].caster &&
          arr[arraySchemaSymbol].caster.options &&
          arr[arraySchemaSymbol].caster.options.ref) ||
        null;
