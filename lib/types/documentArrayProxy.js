...
class CoreDocumentArray extends CoreMongooseArray {
  ...
  inspect() {
    console.log('F', this.isMongooseDocumentArray, this.isMongooseDocumentArrayProxy)
...
module.exports = function arrayProxy(arr) {
  if (inspect) {
    arr[inspect] = CoreDocumentArray.prototype.inspect;
  }
  const proxy = new Proxy(arr, {
    get: function(target, prop) {
      ...
      } else if (CoreMongooseArray.prototype.hasOwnProperty(prop)) {
...
function __set(i, val, skipModified) {
  ...
  const value = CoreDocumentArray.prototype._cast.call(arr, val, i);
  arr[i] = value;
  CoreDocumentArray.prototype._markModified.call(arr, i);
  return arr;
}
