...
const MongooseArray = require('./array'), ObjectId = require('./objectid'), ObjectIdSchema = require('../schema/objectid'), utils = require('../utils'), Document = require('../document');
...
function MongooseDocumentArray(values, path, doc) {
  ...
  for (let i = 0; i < keysMDA.length; ++i) {
