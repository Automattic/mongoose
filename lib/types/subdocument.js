 ...
 * @param {Boolean|Object} [options.middleware=true] If `false`, skip all middleware. If an object, can set `pre` or `post` to `false` to skip pre or post middleware respectively.
...
Subdocument.prototype.$__save = async function $__save(options) {
  ...
  await this._execDocumentPostHooks('save', options, null);
};
