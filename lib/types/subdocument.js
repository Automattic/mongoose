...
Subdocument.prototype.$toObject = function $toObject(options, json) {
  ...
  return this.$__toObjectMinimize(ret, options);
};

Subdocument.prototype.$toObjectInternal = function $toObjectInternal(options, json) {
  const ret = Document.prototype.$toObjectInternal.call(this, options, json);

  return this.$__toObjectMinimize(ret, options);
};

Subdocument.prototype.$__toObjectMinimize = function $__toObjectMinimize(ret, options) {
