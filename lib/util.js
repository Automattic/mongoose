        ...
        Object.getOwnPropertyNames(source).forEach(function(k){
          ...
          if (d.get) {
            ...
            if (deep && d.value && typeof d.value === "object") {
              var t = Object.getOwnPropertyDescriptor(target,k) || {value: target[k]};
              if(typeof target[k] == "object") object.mixin(deep,target[k],source[k])
              else if(t.get && !t.set && typeof t.get() === "object"){
                object.mixin(deep, t.get(), source[k]);
              } else {
