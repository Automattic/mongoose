...
function cloneObject(obj, options) {
  let retainKeyOrder = options && options.retainKeyOrder, minimize = options && options.minimize, ret = {}, hasKeys, keys, val, k, i;
...
exports.options = function(defaults, options) {
  let keys = Object.keys(defaults), i = keys.length, k;
...
exports.object.vals = function vals(o) {
  let keys = Object.keys(o), i = keys.length, ret = [];
...
exports.mergeClone = function(to, fromObj) {
  let keys = Object.keys(fromObj), i = keys.length, key;
