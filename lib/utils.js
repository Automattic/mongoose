...
function PopulateOptions (path, select, match, options, model, repl) {
  this.path = path;
  this.match = match;
  this.select = select;
...
exports.populate = function populate (path, select, model, match, options, repl) {
  ...
  for (var i = 0; i < paths.length; ++i) {
    ret.push(new PopulateOptions(paths[i], select, match, options, model, repl));
  }
