...
block content
  <div class="doc-links">
    ...
    <button class="copy-markdown-link" data-md-url="${markdownUrl}" title="Copy page as Markdown" aria-label="Copy page as Markdown" onclick="fetch(this.dataset.mdUrl).then(r=>r.text()).then(t=>{navigator.clipboard.writeText(t);this.classList.add('copied');setTimeout(()=>this.classList.remove('copied'),2000)})">
