...
describe('Model', function() {
  ...
  describe('Model.useConnection() (gh-14802)', function() {
    ...
    it('should throw a MongooseError if no connection is passed (gh-16098)', async function() {
      const schema = new mongoose.Schema({
        name: String
      });
      const Model = db.model('Test', schema);
      assert.throws(() => {
        Model.useConnection();
      }, { name: 'MongooseError', message: '`useConnection()` requires a Mongoose Connection instance.' });
    });
