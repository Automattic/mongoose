...
const personSchema = new Schema<any, IPerson & Document, Model<IPerson & Document>, IPerson>({
  _id: { type: Number, required: true },
  firstName: { type: String, required: true },
  lastName: { type: String, required: true }
});

const petSchema = new Schema<any, IPet & Document, Model<IPet & Document>, IPet>({
...
function gh11543() {
  const personSchema = new Schema<any, IPerson, Model<IPerson, {}, {}, PetVirtuals>, {}, {}, PetVirtuals>({
    _id: { type: Number, required: true },
    firstName: { type: String, required: true },
    lastName: { type: String, required: true }
  });
