declare module 'mongoose' {
  ...
  class Document<T = any, TQueryHelpers = any, DocType = any> {
    ...
    */
    ...
    toJSON<T = DocType>(options?: ToObjectOptions & { flattenMaps?: true }): FlattenMaps<T>;
    toJSON<T = DocType>(options: ToObjectOptions & { flattenMaps: false }): T;

    /** Converts this document into a plain-old JavaScript object ([POJO](https://masteringjs.io/tutorials/fundamentals/pojo)). */
    toObject<T = DocType>(options?: ToObjectOptions): Require_id<T>;
