...
declare module 'mongoose' {
  ...
  class Document<T = any, TQueryHelpers = any, DocType = any> {
    ...
    */
    ...
    populate<Paths = {}>(path: string | PopulateOptions | (string | PopulateOptions)[], select?: string | AnyObject, model?: Model<unknown>, match?: AnyObject, options?: PopulateOptions, callback?: Callback<this & Paths>): void;
    populate<Paths = {}>(path: string | PopulateOptions | (string | PopulateOptions)[], select?: string | AnyObject, model?: Model<unknown>, match?: AnyObject, options?: PopulateOptions): Promise<this & Paths>;
