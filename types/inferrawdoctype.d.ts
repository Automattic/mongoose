   ...
   */
   type ResolveRawPathType<
     ...
     > =
       ...
       : PathValueType extends Schema<infer RawDocType, any, any, any, any, any, infer TSchemaOptions, infer DocType, any, infer TSchemaDefinition> ? IsItRecordAndNotAny<RawDocType> extends true ? RawDocType : string extends keyof TSchemaDefinition ? TSchemaOptions extends { _id: false } ? FlattenMaps<SubdocsToPOJOs<DocType>> : Require_id<FlattenMaps<SubdocsToPOJOs<DocType>>> : InferRawDocType<TSchemaDefinition, DefaultSchemaOptions, TTransformOptions>
       : PathValueType extends ReadonlyArray<infer Item> ?
         ...
         : Item extends Schema<infer RawDocType, any, any, any, any, any, infer TSchemaOptions, infer DocType, any, infer TSchemaDefinition> ?
           ...
           Array<IsItRecordAndNotAny<RawDocType> extends true ? RawDocType : string extends keyof TSchemaDefinition ? TSchemaOptions extends { _id: false } ? FlattenMaps<SubdocsToPOJOs<DocType>> : Require_id<FlattenMaps<SubdocsToPOJOs<DocType>>> : InferRawDocType<TSchemaDefinition, DefaultSchemaOptions, TTransformOptions>>
