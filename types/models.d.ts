declare module "mongoose" {
  ...
  > extends NodeJS.EventEmitter,
     ...
     */
    bulkWrite(
      writes: Array<mongodb.AnyBulkWriteOperation<T extends {} ? T : any>>,
      options: mongodb.BulkWriteOptions & MongooseBulkWriteOptions,
      callback: Callback<mongodb.BulkWriteResult>
    ): void;
    bulkWrite(
      writes: Array<mongodb.AnyBulkWriteOperation<T extends {} ? T : any>>,
      callback: Callback<mongodb.BulkWriteResult>
    ...
    bulkSave(
      ...
      options?: mongodb.BulkWriteOptions & { timestamps?: boolean }
    ): Promise<mongodb.BulkWriteResult>;
    ...
    createCollection<T extends mongodb.Document>(
      options:
        | (mongodb.CreateCollectionOptions & Pick<SchemaOptions, "expires">)
        | null,
    ...
    insertMany<DocContents = T>(
      ...
      callback: Callback<
        Array<MergeType<MergeType<T, DocContents>, RequireOnlyTypedId<T>>>
      >
    ): void;
    insertMany<DocContents = T>(
      docs: Array<DocContents | T>,
      options: InsertManyOptions & { rawResult: true },
      callback: Callback<mongodb.InsertManyResult<T>>
    ): void;
    insertMany<DocContents = T>(
      docs: Array<DocContents | T>,
      callback: Callback<
        Array<
          HydratedDocument<
            MergeType<MergeType<T, DocContents>, RequireOnlyTypedId<T>>,
            TMethodsAndOverrides,
            TVirtuals
          >
        >
    ...
    exists(
      filter: FilterQuery<T>,
      callback: Callback<{ _id: InferId<T> } | null>
    ): QueryWithHelpers<
    ...
    /** Creates a `findOneAndReplace` query: automatically finds the given document and replaces it with `replacement`. */
    findOneAndReplace<
      ResultDoc = HydratedDocument<T, TMethodsAndOverrides, TVirtuals>
    >(
      filter: FilterQuery<T>,
